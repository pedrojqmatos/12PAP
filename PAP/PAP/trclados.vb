...
Public Class trclados
    ...
    Private Sub PictureBox1_Click(sender As Object, e As EventArgs) Handles PictureBox1.Click
        ...
        cmd.CommandText = "insert into teclados(TE_ID, TE_Nome, TE_Marca, TE_Modelo, TE_Conexao)values(@id,@nome,@marca,@modelo,@conexao);"
        cmd.Parameters.AddWithValue("@id", Label6.Text)
        cmd.Parameters.AddWithValue("@nome", txtnome.Text)
        cmd.Parameters.AddWithValue("@conexao", cbxInterface.Text)
    ...
    Private Sub codigo()
        ...
        ds1.Tables.Add(dt1)
        Dim da1 As New MySqlDataAdapter("SELECT * FROM teclados", connection)
        da1.Fill(dt1)
    ...
    Private Sub lista()
        ...
        ds.Tables.Add(dt)
        Dim da As New MySqlDataAdapter("SELECT * FROM teclados", connection)
        da.Fill(dt)
    ...
    Private Sub trclados_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        cbxpesquisa.Text = "Nome"
        codigo()
        lista()
        teclados_aberto = True
    End Sub

    Private Sub trclados_Closed(sender As Object, e As EventArgs) Handles Me.Closed
        teclados_aberto = False
    End Sub
    ...
    Private Sub PictureBox2_Click(sender As Object, e As EventArgs) Handles PictureBox2.Click
        ...
        connection.Open()
        cmd = connection.CreateCommand()
        cmd.CommandText = "delete from teclados where TE_ID=@id;"
        cmd.Parameters.AddWithValue("@id", Label6.Text)
        cmd.ExecuteNonQuery()
        connection.Close()
        limpa()
    ...
    Private Function marca_ja_existe(marca As String) As Boolean
        Dim cmd As MySqlCommand
        cmd = connection.CreateCommand()
        cmd.CommandText = "Select count(*) from teclados where TE_ID = @ID"
    ...
    Private Sub PictureBox3_Click(sender As Object, e As EventArgs) Handles PictureBox3.Click
        ...
        connection.Open()
        cmd = connection.CreateCommand()
        cmd.CommandText = "update teclados set TE_Nome=@nome, TE_Conexao=@conexao, TE_Modelo=@modelo, TE_Marca=@marca where TE_ID=@id;"
        cmd.Parameters.AddWithValue("@id", Label6.Text)
        cmd.Parameters.AddWithValue("@nome", txtnome.Text)
        cmd.Parameters.AddWithValue("@conexao", cbxInterface.Text)
        cmd.Parameters.AddWithValue("@modelo", txtmodelo.Text)
    ...
    Private Sub txtpesquisa_TextChanged(sender As Object, e As EventArgs) Handles txtpesquisa.TextChanged
        If cbxpesquisa.Text = "ID" Then
            ...
            Dim ds As New DataSet
            ds.Tables.Add(dt)
            Dim da As New MySqlDataAdapter("SELECT * FROM teclados where TE_ID Like '%" & txtpesquisa.Text & "%' Order By TE_ID", connection)
            da.Fill(dt)
            Dim coluna As DataRow
            For Each coluna In dt.Rows
                ListView1.Items.Add(coluna.Item(0))
        ...
        ElseIf cbxpesquisa.Text = "Nome" Then
            ...
            Dim ds As New DataSet
            ds.Tables.Add(dt)
            Dim da As New MySqlDataAdapter("SELECT * FROM teclados where TE_Nome Like '%" & txtpesquisa.Text & "%' Order By TE_Nome", connection)
            da.Fill(dt)
            Dim coluna As DataRow
            For Each coluna In dt.Rows
                ListView1.Items.Add(coluna.Item(0))
        ...
        ElseIf cbxpesquisa.Text = "Interface" Then
            ...
            Dim ds As New DataSet
            ds.Tables.Add(dt)
            Dim da As New MySqlDataAdapter("SELECT * FROM teclados where TE_Conexao Like '%" & txtpesquisa.Text & "%' Order By TE_Conexao", connection)
            da.Fill(dt)
            Dim coluna As DataRow
            For Each coluna In dt.Rows
                ListView1.Items.Add(coluna.Item(0))
        ...
        ElseIf cbxpesquisa.Text = "Marca" Then
            ...
            Dim ds As New DataSet
            ds.Tables.Add(dt)
            Dim da As New MySqlDataAdapter("SELECT * FROM teclados where TE_Marca Like '%" & txtpesquisa.Text & "%' Order By TE_Marca", connection)
            da.Fill(dt)
            Dim coluna As DataRow
            For Each coluna In dt.Rows
                ListView1.Items.Add(coluna.Item(0))
        ...
        ElseIf cbxpesquisa.Text = "modelo" Then
            ...
            Dim ds As New DataSet
            ds.Tables.Add(dt)
            Dim da As New MySqlDataAdapter("SELECT * FROM teclados where TE_Modelo Like '%" & txtpesquisa.Text & "%' Order By TE_Modelo", connection)
            da.Fill(dt)
            Dim coluna As DataRow
            For Each coluna In dt.Rows
                ListView1.Items.Add(coluna.Item(0))
