...
Public Class Marca
    ...
    Private Sub PictureBox1_Click(sender As Object, e As EventArgs) Handles PictureBox1.Click
        If marca_ja_existe(TextBox1.Text) Then
            MessageBox.Show("Essa marca já existe na tabela!", "aviso", MessageBoxButtons.OK, MessageBoxIcon.Warning)
            Return
        End If
        ...
        cmd.CommandText = "insert into marca(Marca)values(@marca);"
    ...
    Private Sub PictureBox3_Click(sender As Object, e As EventArgs) Handles PictureBox3.Click
        ...
        connection.Open()
        cmd = connection.CreateCommand()
        cmd.CommandText = "delete from marca where Marca=@marca;"
        cmd.Parameters.AddWithValue("@marca", TextBox1.Text)
        cmd.ExecuteNonQuery()
        connection.Close()
        lista()
    ...
    Private Function marca_ja_existe(marca As String) As Boolean
        Dim cmd As MySqlCommand
        cmd = connection.CreateCommand()
        cmd.CommandText = "Select count(*) from marca where Marca = @marca"
    ...
    Private Sub TextBox2_TextChanged(sender As Object, e As EventArgs) Handles TextBox2.TextChanged
        ...
        Dim ds As New DataSet
        ds.Tables.Add(dt)
        Dim da As New MySqlDataAdapter("Select * FROM marca where Marca Like '%" & TextBox2.Text & "%' Order By Marca", connection)
        da.Fill(dt)
        Dim coluna As DataRow
        For Each coluna In dt.Rows
            ListView1.Items.Add(coluna.Item(0))
